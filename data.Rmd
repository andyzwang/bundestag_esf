...
<details>
  <summary>PLZ-BWK Crosswalk R Code [[GitHub](https://github.com/andyzwang/bundestag_esf/blob/main/coding/geomatching.R)]</summary>
  ```r
  library(sf)
  library(dplyr)
  library(purrr)
...
Ultimately, 8,256 PLZs were matched to the 299 electoral districts, with 91 postal codes spread across 2 electoral districts, and 2 spread across 3 electoral districts. 
...
* North-Rhine Westphalia, `.xlsx` [[Ministerium für Arbeit, Gesundheit und Soziales](https://www.mags.nrw/system/files/media/document/file/esf_2021-2027_liste_der_vorhaben.xlsx), as of 31.12.2023] 

### Geocoding

* Postleitzahl Shapefile, `.geoJSON` [[Postleitzahlen Deutschland](https://downloads.suche-postleitzahl.org/v2/public/plz-5stellig.geojson), as of 15.07.2023]^[[Open Database License](https://www.openstreetmap.org/copyright)]
* Bundestag Constituency Shapefile, `.geoJSON` [[Bundeswahlleiter](https://www.bundeswahlleiterin.de/en/dam/jcr/f0ce06a7-188c-4ef3-b49b-5a66719d2b46/btw21_geometrie_wahlkreise_vg250_shp.zip), as of 15.04.2020]
* Bundestag Constituency Names, `.csv` [[Bundeswahlleiter](https://www.bundeswahlleiterin.de/dam/jcr/b46e4c9d-290c-4b96-a64b-0edee1c780a5/btw21_wahlkreisnamen_utf8.csv), as of 15.04.2020]
